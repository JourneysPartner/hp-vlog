...
const TOPICS = [
  ...
  { persona: 'domestic_ec_seller', category: 'インボイス', quality: 'standard',
    ...
    source_url: 'https://www.nta.go.jp/taxes/shiraberu/taxanswer/shohi/6253.htm',
    source_title: '国税庁タックスアンサー No.6253 免税事業者からの仕入れに係る経過措置',
  ...
  // ════════════════════════════════════════════════════════════
  //  【一般事業者】法人化・社保・所得区分（業種横断）
  // ════════════════════════════════════════════════════════════
  { persona: 'influencer_creator', category: '所得税', quality: 'high',
    macro: '一般事業者', cluster: 'incorporation', subcluster: 'general-incorporation-decision', tax_domain: 'income_tax',
    ...
    source_url: 'https://www.nta.go.jp/taxes/shiraberu/taxanswer/shotoku/2260.htm',
    source_title: '国税庁タックスアンサー No.2260 所得税の税率',
    hint: '所得税率vs法人税率・社会保険料負担・役員報酬設計の論点を業種横断で整理',
  ...
  { persona: 'influencer_creator', category: '所得税', quality: 'standard',
    macro: '一般事業者', cluster: 'income-classification', subcluster: 'side-job-income-classification', tax_domain: 'income_tax',
    article_type: 'edge_case',
    title: '副業の所得は事業所得？雑所得？判断基準と帳簿要件で変わる扱い',
    slug: 'general-side-income-business-vs-misc-classification',
    source_url: 'https://www.nta.go.jp/taxes/shiraberu/taxanswer/shotoku/1350.htm',
    source_title: '国税庁タックスアンサー No.1350 事業所得の課税のしくみ',
    hint: '300万円基準・帳簿保存・反復継続性・本業との関係',
  ...
  { persona: 'reseller_marketplace_seller', category: '所得税', quality: 'standard',
    macro: '一般事業者', cluster: 'social-insurance', subcluster: 'sole-proprietor-social-insurance', tax_domain: 'income_tax',
    article_type: 'misconception_fix',
    ...
    hint: '国保・国民年金・扶養の130万円/106万円基準と所得税の扶養要件の違い',
  ...
  { persona: 'domestic_ec_seller', category: '所得税', quality: 'standard',
    macro: '一般事業者', cluster: 'family-employment', subcluster: 'family-employment-payroll', tax_domain: 'income_tax',
    article_type: 'filing_practice',
    ...
    hint: '青色事業専従者給与に関する届出書・適正な給与水準・年末調整',
  ...
  { persona: 'beauty_salon_owner', category: '帳簿・経費', quality: 'standard',
    macro: '税目実務', cluster: 'bookkeeping', subcluster: 'bookkeeping-basics', tax_domain: 'bookkeeping_expenses',
    article_type: 'basic_explainer',
    title: '個人事業主の帳簿付け入門｜白色・青色での違いと最低限の記帳ルール',
    slug: 'tax-bookkeeping-basics-for-sole-proprietor',
    source_url: 'https://www.nta.go.jp/taxes/shiraberu/taxanswer/shotoku/2080.htm',
    source_title: '国税庁タックスアンサー No.2080 白色申告者の記帳・帳簿等の保存',
    hint: '単式/複式の違い・帳簿保存期間・最低限の科目設定',
  ...
  { persona: 'domestic_ec_seller', category: '消費税', quality: 'standard',
    macro: '税目実務', cluster: 'consumption-tax-basics', subcluster: 'consumption-tax-thresholds', tax_domain: 'consumption_tax',
    article_type: 'basic_explainer',
    title: '消費税の課税事業者になる基準｜1000万円・特定期間・新設法人の判定',
    slug: 'tax-consumption-tax-taxable-business-threshold',
    source_url: 'https://www.nta.go.jp/taxes/shiraberu/taxanswer/shohi/6501.htm',
    source_title: '国税庁タックスアンサー No.6501 納税義務の免除',
    hint: '基準期間1000万円・特定期間・新設法人特例・課税事業者選択届出',
  ...
  { persona: 'influencer_creator', category: '所得税', quality: 'standard',
    macro: '税目実務', cluster: 'withholding', subcluster: 'withholding-receivers-side', tax_domain: 'withholding',
    article_type: 'misconception_fix',
    title: '報酬から源泉徴収された場合の確定申告｜引かれた税金は戻るのか？',
    slug: 'tax-withholding-refund-confirmation-by-tax-return',
    source_url: 'https://www.nta.go.jp/taxes/shiraberu/taxanswer/gensen/2792.htm',
    source_title: '国税庁タックスアンサー No.2792 源泉徴収が必要な報酬・料金',
    hint: '源泉徴収済み所得税の還付・支払調書・確定申告での精算',
