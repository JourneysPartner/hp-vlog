...
const SCOPES = {
  ...
  // 2026-09-14: 「一括贈与」と「税制改正」は語が広すぎた。農地等の「生前一括贈与」の
  // 記事に教育資金のパンフレットが添付された（貸付農地の納税猶予の記事）。
  // この資料の主題は教育資金・結婚子育て資金の非課税と、暦年課税／相続時精算課税の改正。
  sozoku_pamph: ['教育資金', '結婚・子育て資金', '相続時精算課税', '暦年課税', '生前贈与加算', '持ち戻し', '加算期間'],
};
