...
const SEGMENTS = {
  ...
  content_seller: {
    ...
    subLabels: {
      note: 'note・有料記事', course: 'オンライン講座', membership: 'オンラインサロン',
      ebook: '電子書籍・PDF教材', template: 'テンプレ・素材販売',
    },
    stages: [
      { id: 'side', label: '副業' }, { id: 'pro', label: '専業' }, { id: 'incorp', label: '法人化検討' },
    ],
    themes: [
      ...
      { id: 'content-invoice', tax_domain: 'invoice_system',
        ...
        success: 'インボイス登録の要否を自分のケースで判断できる' },
      // ── コンテンツ種別ごとの特化テーマ ──────────────────
      { id: 'content-membership-tiers', tax_domain: 'income_tax', subs: ['membership'],
        topic: '会員ランク別課金（サブスク）の売上計上',
        q: 'オンラインサロンの会員ランク別課金はどう売上計上する？',
        intent: 'オンラインサロン 会員 ランク 課金 売上計上 どう',
        reader: '複数プランの継続課金の計上単位が分からない',
        success: '会員課金の売上計上の考え方が分かる' },
      { id: 'content-course-bundle', tax_domain: 'consumption_tax', subs: ['course'],
        topic: '講座と個別コンサルのセット販売の区分',
        q: '講座＋個別コンサルのセット販売は消費税・売上をどう区分する？',
        intent: 'オンライン講座 コンサル セット 販売 区分 消費税',
        reader: 'セット販売の対価区分と課税判定が不安',
        success: 'セット販売の区分と課税処理が分かる' },
      { id: 'content-ebook-royalty', tax_domain: 'income_tax', subs: ['ebook'],
        topic: '電子書籍（Kindle等）の印税収入の申告',
        q: '電子書籍の印税収入はどう確定申告する？',
        intent: '電子書籍 Kindle 印税 収入 確定申告 どう',
        reader: 'プラットフォーム経由の印税の計上・区分が不安',
        success: '電子書籍の印税収入の計上と申告が分かる' },
      { id: 'content-license-revenue', tax_domain: 'income_tax', subs: ['template'],
        topic: 'テンプレ・素材のライセンス／二次利用収入',
        q: 'テンプレや素材の販売・ライセンス収入はどう計上する？',
        intent: 'テンプレ 素材 販売 ライセンス 収入 売上計上',
        reader: '二次利用・再販の収入区分が分からない',
        success: 'ライセンス収入の計上の考え方が分かる' },
      // ── 開業ステージ（副業/専業/法人化）で展開 ────────────
      { id: 'content-tax-return-need', tax_domain: 'income_tax', useStage: true,
        topic: 'コンテンツ販売で確定申告が必要になるライン',
        q: 'コンテンツ販売の収入はいくらから確定申告が必要？',
        intent: 'コンテンツ販売 収入 いくら 確定申告 必要',
        reader: '自分の収入規模で申告が必要か分からない',
        success: '申告が必要になる収入ラインと手続きが分かる' },
      { id: 'content-income-classification', tax_domain: 'income_tax', useStage: true,
        topic: 'コンテンツ販売の収入は事業所得か雑所得か',
        q: 'コンテンツ販売の収入は事業所得？雑所得？',
        intent: 'コンテンツ販売 収入 事業所得 雑所得 どちら',
        reader: '所得区分で税額や控除が変わり判断に迷う',
        success: '事業所得・雑所得の判断軸が分かる' },
    ],
  },
  ...
  construction_solo: {
    ...
    subLabels: {
      interior: '内装', electrical: '電気工事', plumbing: '配管・設備',
      painting: '塗装', carpenter: '大工',
    },
    // 就業形態（外注/給与判定などが変わる軸）
    stages: [
      { id: 'ukeoi', label: '請負中心' }, { id: 'joyou', label: '常用中心' },
    ],
    themes: [
      ...
      // ── 職種ごとの特化テーマ ────────────────────────────
      { id: 'construction-qualification-cost', tax_domain: 'bookkeeping_expenses', subs: ['electrical', 'plumbing'],
        topic: '資格更新・講習費、専用工具の経費',
        q: '電気工事・配管の資格更新費や専用工具は経費になる？',
        intent: '電気工事 配管 資格 更新 講習費 工具 経費 なる',
        reader: '資格維持費や専門工具の経費区分が分からない',
        success: '資格更新費・専用工具の経費計上が分かる' },
      { id: 'construction-consumables', tax_domain: 'bookkeeping_expenses', subs: ['painting'],
        topic: '塗料・消耗品の在庫と経費計上',
        q: '塗装の塗料・消耗品はどう経費・在庫計上する？',
        intent: '塗装 塗料 消耗品 在庫 経費 計上 どう',
        reader: '使い切らない材料の在庫・経費区分が不安',
        success: '塗料・消耗品の経費と在庫計上が分かる' },
      { id: 'construction-power-tools', tax_domain: 'bookkeeping_expenses', subs: ['carpenter', 'interior'],
        topic: '大型・電動工具の減価償却と少額特例',
        q: '大工・内装の電動工具は減価償却？一括経費？',
        intent: '大工 内装 電動工具 減価償却 少額特例 経費 どちら',
        reader: '高額工具の一括経費か減価償却か分からない',
        success: '工具の減価償却・少額特例の判断ができる' },
      // ── 就業形態（請負/常用）で外注給与判定が変わる ────────
      { id: 'construction-workform-judgment', tax_domain: 'withholding', useStage: true,
        topic: '請負・常用で外注費/給与や源泉はどう変わるか',
        q: '請負中心と常用中心で外注費・給与や源泉の扱いはどう違う？',
        intent: '1人親方 請負 常用 外注費 給与 源泉 違い',
        reader: '就業形態で税務の扱いが変わるのか分からない',
        success: '請負・常用での外注給与判定と源泉の違いが分かる' },
    ],
  },
  ...
  retail_store: {
    ...
    subLabels: {
      apparel: 'アパレル', food: '食品', variety: '雑貨',
      select: 'セレクトショップ', souvenir: '土産物店',
    },
    themes: [
      ...
      { id: 'retail-gift-certificate', tax_domain: 'consumption_tax',
        topic: '商品券・ギフトカードを受け取った場合の処理',
        q: '商品券やギフトカードで支払われたときの売上・消費税は？',
        intent: '小売店 商品券 ギフトカード 受取 売上 消費税 どう',
        reader: '金券受取時の売上計上と消費税の扱いが不安',
        success: '金券・商品券の売上計上と消費税処理が分かる' },
      // ── 商品ジャンルごとの特化テーマ ────────────────────
      { id: 'retail-food-eatin', tax_domain: 'consumption_tax', subs: ['food', 'souvenir'],
        topic: 'イートイン・テイクアウトの税率区分',
        q: 'イートインとテイクアウトで軽減税率はどう変わる？',
        intent: '食品 イートイン テイクアウト 軽減税率 区分 どちら',
        reader: '店内飲食と持ち帰りの税率判定が分からない',
        success: 'イートイン・テイクアウトの税率区分が分かる' },
      { id: 'retail-apparel-season-inventory', tax_domain: 'bookkeeping_expenses', subs: ['apparel', 'variety'],
        topic: '季節商品・売れ残り在庫の評価',
        q: 'アパレルの売れ残り・型落ち在庫はどう評価する？',
        intent: 'アパレル 季節商品 売れ残り 在庫 評価 低価法',
        reader: '値下げ・処分品の在庫評価が分からない',
        success: '売れ残り在庫の評価と評価損の考え方が分かる' },
      { id: 'retail-consignment-sales', tax_domain: 'income_tax', subs: ['souvenir', 'select'],
        topic: '委託販売・消化仕入の売上計上',
        q: '委託販売や消化仕入のときの売上計上はどうする？',
        intent: '土産物 委託販売 消化仕入 売上計上 いつ',
        reader: '預り在庫・委託の売上認識の時期が分からない',
        success: '委託販売・消化仕入の売上計上時期が分かる' },
    ],
  },
  ...
  wholesale: {
    ...
    subLabels: {
      food: '食品卸', apparel: 'アパレル卸', material: '資材・工業卸', general: '業務用商品卸',
    },
    themes: [
      ...
      // ── 取扱品ジャンルごとの特化テーマ ──────────────────
      { id: 'wholesale-food-loss', tax_domain: 'bookkeeping_expenses', subs: ['food'],
        topic: '食品卸の廃棄・期限切れロスの処理',
        q: '食品卸の廃棄・期限切れロスはどう処理する？',
        intent: '食品卸 廃棄 期限切れ ロス 在庫 処理 どう',
        reader: '廃棄ロスの経費計上と在庫調整が分からない',
        success: '廃棄・期限切れロスの処理と在庫調整が分かる' },
      { id: 'wholesale-consignment', tax_domain: 'income_tax', subs: ['general', 'material'],
        topic: '委託販売・預け在庫の売上計上',
        q: '委託販売や預け在庫があるときの売上計上は？',
        intent: '卸売 委託販売 預け在庫 売上計上 いつ',
        reader: '預け在庫の売上認識時期が分からない',
        success: '委託販売・預け在庫の売上計上時期が分かる' },
      { id: 'wholesale-apparel-return', tax_domain: 'consumption_tax', subs: ['apparel'],
        topic: 'アパレル卸の返品・シーズン値引の処理',
        q: 'アパレル卸の大量返品・シーズン値引はどう処理する？',
        intent: 'アパレル卸 返品 シーズン 値引 処理 消費税',
        reader: '季節返品・値引の売上と消費税調整が不安',
        success: '返品・シーズン値引の処理と消費税区分が分かる' },
    ],
  },
};
