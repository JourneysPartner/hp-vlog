...
原則は短く言えます。メルカリ販売手数料（売上の10%）は「支払手数料」として経費計上し、消費税区分は**課税仕入れ**です。ただし、自身が課税事業者かどうか、インボイス制度との関係など、条件によって処理が変わる場面があります。本記事では判断に迷いやすい3つのケースを具体的に整理します。
...
**自力で対応しやすいケース**
- 免税事業者で、単純に手数料を経費として記録するだけのとき
- 売上・手数料の明細がメルカリ管理画面で取得できており、仕訳が一対一で対応しているとき

**専門家に相談した方がよいケース**
- 課税事業者に切り替わるタイミングで、インボイス登録や簡易課税の選択を迷っているとき
- 個人間取引（フリマ仕入れ）が多く、仕入税額控除の取り扱いが複雑になっているとき
- 副業から本業化し、所得区分（雑所得・事業所得）の判断も含めて整理したいとき

---

## まとめ

メルカリの販売手数料は「支払手数料」として費用計上し、課税事業者であれば課税仕入れとして処理するのが基本です。免税事業者のうちは消費税の区分を深く意識しなくてよいものの、売上が拡大するにつれて処理の複雑さは増していきます。取引明細は都度ダウンロードして保存し、帳簿との照合を習慣化しておくと、申告時の作業が大幅に楽になります。
