...
> 基準期間（2年前）および特定期間（前年1〜6月）の課税売上高が<strong>いずれも</strong>1,000万円以下であること

この記述は「課税売上高のみ」で判定するように読めますが、論点別ルールによれば「給与等支払額による選択肢」が省かれており、不正確です。ただし論点別ルールは「OR（いずれか）で書くのが誤り」であり、この記述は「AND（いずれも）」で書いているため、誤記パターンとは異なります。

より精査すると、問題は「課税売上高がいずれも1,000万円以下」という表現が、給与等支払額による選択肢を書いていない点です。論点別ルールに従い、「課税売上高による判定が原則で、給与等支払額で代えることも選択できる」旨を最小限加筆します。
