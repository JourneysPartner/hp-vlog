...
summary: "一人親方は原則として年間所得48万円超で確定申告が必要。請求書・領収書・源泉徴収票を揃え、白色または青色申告で事業所得を申告する手順を解説します。"
review_status: "draft"
review_comment: ""
approved_at: ""
publish_at: ""
...
これらの疑問に、建設業の一人親方という立場に寄り添って答えていきます。結論から言うと、<strong>一人親方は原則として確定申告が必要で、収入から経費を引いた所得が48万円（令和7年分）を超えれば申告義務が生じます</strong>。必要書類をそろえて手順どおりに進めれば、初めての方でも対応できます。
...
義務が生じる基準は、<strong>事業所得（売上から必要経費を引いた額）が48万円を超えるかどうか</strong>（令和7年分。基礎控除額が判断の基準になります）。年間の受注額が小さくても、経費を引いた後の所得が48万円を超えていれば申告が必要です。逆に、経費が多く所得がそれ以下に収まる年は申告義務がない場合もあります。

なお、令和8年分以後は基礎控除額が62万円に引き上げられる予定です（令和8年度税制改正）。令和7年分の申告（2026年2月〜3月提出）では48万円が基準になるので注意してください。
...
青色申告を選ぶには、原則として申告する年の<strong>3月15日まで（新規開業の場合は開業後2か月以内）に「青色申告承認申請書」を税務署に提出</strong>しておく必要があります。まだ提出していない場合、今年分は白色申告で対応し、来年分から青色申告に切り替える流れになります。
...
事業所得（売上から必要経費を差し引いた金額）が48万円以下であれば、令和7年分は申告不要です（所得税の基礎控除額が目安）。ただし売上金額ではなく所得金額が基準なので、経費が多い場合は売上が高くても申告不要になることがあります。なお令和8年分以後は基礎控除が62万円に引き上げられる予定です。
...
来年分から青色申告にしたい場合は、<strong>今年の3月15日まで</strong>に「所得税の青色申告承認申請書」を税務署に提出します。e-Taxでも提出できます。承認されれば翌年分（提出年の1月1日分）から青色申告が適用されます。

## まとめ

一人親方は年末調整がないため、毎年自分で確定申告を行う必要があります。事業所得（収入－経費）が48万円を超えれば申告義務が生じます（令和7年分）。
