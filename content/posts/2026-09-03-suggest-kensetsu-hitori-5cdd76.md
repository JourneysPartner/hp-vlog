...
summary: "一人親方は所得が基礎控除額（令和8年分は合計所得489万円以下で104万円）を超えると確定申告が必要。請求書・領収書・源泉徴収票を揃え、白色または青色申告で申告する手順を解説します。"
review_status: "draft"
review_comment: ""
approved_at: ""
publish_at: ""
...
これらの疑問に、建設業の一人親方という立場に寄り添って答えていきます。結論から言うと、<strong>一人親方は原則として確定申告が必要で、収入から経費を引いた所得が基礎控除額を超えれば申告義務が生じます</strong>。いま働いている分は<strong>令和8年分</strong>（申告は令和9年2月〜3月）にあたり、基礎控除額は合計所得金額489万円以下の方で104万円です。必要書類をそろえて手順どおりに進めれば、初めての方でも対応できます。
...
義務が生じる基準は、<strong>事業所得（売上から必要経費を引いた額）が基礎控除額を超えるかどうか</strong>です。令和8年分の基礎控除額は、合計所得金額489万円以下の方で<strong>104万円</strong>（基礎控除62万円＋令和8年・令和9年の特例加算42万円）。年間の受注額が小さくても、経費を引いた後の所得がこの額を超えていれば申告が必要です。逆に、経費が多く所得がそれ以下に収まる年は申告義務がない場合もあります。

基礎控除額は年分ごとに違うため、「何年分の話か」を必ず確認してください。令和7年分（令和8年2月〜3月にすでに申告が終わっている年分）は合計所得金額132万円以下で95万円、令和8年分は489万円以下で104万円です。よく見かける「48万円」は令和6年分以前の金額なので、いまの判断に使うと誤りになります。

なお実際には、基礎控除のほかに国民健康保険料・国民年金保険料などの社会保険料控除も差し引けます。申告義務が生じる所得のラインは、上記の基礎控除額よりさらに高くなるのが通常です。
...
事業所得（売上から必要経費を差し引いた金額）が基礎控除額以下であれば申告は不要です。<strong>令和8年分</strong>の基礎控除額は、合計所得金額489万円以下の方で104万円です。ただし売上金額ではなく所得金額が基準なので、経費が多い場合は売上が高くても申告不要になることがあります。社会保険料控除など他の所得控除も差し引けるため、実際のラインはこれより高くなります。
...
一人親方は年末調整がないため、毎年自分で確定申告を行う必要があります。事業所得（収入－経費）が基礎控除額を超えれば申告義務が生じます。令和8年分の基礎控除額は、合計所得金額489万円以下の方で104万円です。
