...
国税庁タックスアンサー No.6105「課税の対象」によれば、消費税は<strong>国内における商品の販売・サービスの提供等のほぼ全てを課税の対象</strong>とするものです。標準税率は10%（うち地方消費税2.2%）で、非課税となるのは課税の対象になじまない一定の取引や社会政策的な配慮から非課税とされた取引に限られます。
