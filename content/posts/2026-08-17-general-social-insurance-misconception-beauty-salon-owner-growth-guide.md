...
updated_at: "2026-08-19T12:00:56.239+09:00"
...
<strong>社会保険の扶養</strong>は「年収130万円未満」、<strong>税の扶養（配偶者控除）</strong>は「合計所得金額58万円以下（令和7年分以後）」が基本の判定ラインです。この2つは根拠となる法律も、判定に使う金額の定義も異なります。
...
| 判定の基準額 | 年間収入130万円未満（自営業者は当該事業遂行のための必要経費を控除した額） | 合計所得金額58万円以下（令和7年分以後） |
...
社会保険は必要経費（当該事業遂行のための経費）を控除した年間収入130万円未満（日本年金機構・厚生労働省）、税の扶養は必要経費を差し引いた合計所得金額58万円以下（令和7年分以後）という判定基準のズレが、多くの混乱を生んでいます。
