---
title: "[要レビュー] deepdive-beauty_salon_owner-software-depreciation-guide"
...
| 自社開発・外注開発ソフト | 20万円以上 | 無形固定資産として減価償却（耐用年数5年） |

国税庁タックスアンサー No.2210「やさしい必要経費の知識」でも、事業に必要な費用は原則として必要経費に算入できると示されています。ただしソフトウェアのように複数年にわたって使用するものは、資産として計上してから減価償却で費用化するのが原則です。
...
なお、<strong>青色申告をしている個人事業主や中小法人</strong>であれば、30万円未満のソフトウェアについて「少額減価償却資産の特例」を使って取得年度に全額経費計上できる場合があります（年間合計300万円までの上限あり）。この特例が使えるかどうかは、事業規模や申告方法によって異なります。
...
開発費用が<strong>20万円以上</strong>になる場合は無形固定資産として計上し、耐用年数5年で減価償却します。20万円未満であれば全額を経費計上できます。
...
| 少額減価償却特例の適用を確認せず資産計上 | 青色申告者なら30万円未満は特例検討 |
...
- 少額減価償却特例の年間上限（300万円）に近づいている
- ソフトウェアを売却・廃棄した場合の除却損の処理
- 法人と個人事業主で処理が異なる点を確認したい

## まとめ

ソフトウェアの費用処理は、<strong>購入型は金額で判断、サブスクは全額経費、開発型は金額で判断</strong>という基本軸で整理できます。特に購入型のパッケージソフトは10万円を境に扱いが変わり、青色申告者には少額減価償却特例という選択肢もあります。サブスク型は所有権が移らないため減価償却の対象にはならない点を押さえておくと、判断で迷う場面が減ります。
