...
review_comment: "「調整する消費税額の計算式は次のとおりです。」→「調整する消費税額の計算式は次のとおりです。※国税部分のみ」に変更して。\n\n「たとえば税込割戻し額が11,000円なら、控除できる消費税は780円（11,000円 × 7.8/110）です。\n\n（借方）売上値引 10,000円 ／ （貸方）現金（または売掛金） 11,000円\n      仮受消費税    780円\n      （差額は端数処理）」→「たとえば税込割戻し額が11,000円なら、控除できる消費税は1000円（11,000円 × 10/110）です。\n\n（借方）売上値引 10,000円 ／ （貸方）現金（または売掛金） 11,000円\n      仮受消費税    1000円\n      （差額は端数処理）」に変更して。"
approved_at: ""
publish_at: ""
published_at: ""
pr_number: ""
...
updated_at: "2026-09-15T16:16:14.840+09:00"
---
