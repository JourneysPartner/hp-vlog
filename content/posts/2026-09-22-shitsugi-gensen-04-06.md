...
updated_at: "2026-09-22T00:11:12.593Z"
---
...
インフルエンサーやクリエイターの方でも、事務所や制作会社との間で業務委託契約を結んでいたり、複数の法人から役員退職金を受け取ったりするケースがあります。特に複数の活動拠点を持つ方は、このような状況が起きやすいため、仕組みを把握しておくことが重要です。
...
ここで問題になるのが「支払者は受給者の申告に基づいて適法に徴収した」という解釈です。これは正しくありません。
...
| 2 | 2か所目の申告書に1か所目の金額を記載したか | 記載した→通常通り源泉徴収済のはず / 記載しなかった→次へ |
| 3 | 記載漏れにより源泉税額に不足が生じているか | 不足あり→支払者（会社）に連絡が必要 |
| 4 | 確定申告で精算できるか | <strong>できない。支払者が是正する</strong> |
...
しかし退職所得は、原則として分離課税の扱いで、受給時の源泉徴収で課税が完結する所得区分です。申告書を提出して適正に源泉徴収を受けていれば確定申告は不要というのが基本のルールです。

この「源泉徴収で完結」という構造が、記載漏れによる不足分の精算まで「確定申告でできるはずがない」という結論につながっています。

### 「支払者は適法に徴収した」という誤解

誤った申告書の記載に基づいて源泉徴収した場合、「支払者は受給者の申告通りに徴収したのだから問題ない」と考えてしまうことがあります。しかし、そもそも記載事項に誤りがある申告書は有効な申告書とはみなされません。支払者はその誤りを知った時点で是正義務を負い、「受給者の申告に基づいて適法に徴収した」という免責は成立しません。
...
- [ ] 同じ年に複数の退職金を受け取っているか
- [ ] それぞれの退職金について「退職所得の受給に関する申告書」を提出したか
...
### インフルエンサーや法人役員として複数の法人から退職金を受け取る場合も同じですか？
